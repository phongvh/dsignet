  ...
  <div id="wrapper">
    ...
    <div id="header">
        ...
        <?php if (isset($primary_links)) : ?>
          <?php //echo "<pre>"; print_r($secondary_links); exit;?>
    ...
    <div id="content-region">
      <div id="partern-1">
        <div class="welcome"><h1>Welcome&nbsp; to&nbsp; Design&nbsp; Network:</h1>
        <div><h2>let us know your genius!</h2></div></div>
        <div id="partern-1-region">
          <?php print $partern1; ?>          
          <div id="f-t-g"><a href="#"><img src="<?php print $base_url.'/'.$directory ?>/images/f_t_g.png"></a><br/>
          Sign up or login with Facebook & Twitter</div>
        </div>
      </div>
        <div id="partern-2">
          <h2>Haven't got an account? Join now! </h2>
          <div id="partern-1-region">
